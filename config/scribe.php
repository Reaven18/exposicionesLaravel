...
return [
    ...
    'auth' => [
        ...
        'default' => true, // Cambia a true para que todos los endpoints lo pidan por defecto
        'in' => 'bearer',  // Indica que usas Bearer Token
        'name' => 'Authorization',
        'use_value' => 'TOKEN_GENERADO_EN_LOGIN', // Valor de ejemplo para el botón "Try it out"
